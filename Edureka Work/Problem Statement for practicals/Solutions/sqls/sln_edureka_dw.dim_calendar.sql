--problem statement :
-- calendat data is placed at local edge node path as comma separated file. We need to create a manager table and load the data from this file
...
LOAD DATA LOCAL INPATH '/mnt/bigdatapgp/edureka_719925/data_prep/dim_calendar' OVERWRITE INTO TABLE edureka_dw.dim_calendar_stage;
...
--Script to load data from stage table to target table in hive
