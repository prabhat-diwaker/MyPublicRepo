*************************data prep :
load data to mysql table from a local file.

drop table if exists labuser_database.fact_sales ;
create table labuser_database.fact_sales 
(
	item_id int,
	store_nbr int,
	sales varchar(1000)
...
LOAD DATA LOCAL INFILE '/mnt/bigdatapgp/edureka_719925/data_prep/fact_sales/sales.txt' INTO TABLE labuser_database.fact_sales FIELDS TERMINATED BY '|' LINES TERMINATED BY '\n' ;
