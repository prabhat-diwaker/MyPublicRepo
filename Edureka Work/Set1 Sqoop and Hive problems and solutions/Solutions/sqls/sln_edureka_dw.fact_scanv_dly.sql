...
--Problem statement : we have scanv_data in orc format at HDFS location '/mnt/bigdatapgp/edureka_719925/data_prep/dim_calendar'. Load this data to fact_scanv_dly target table partitioned by geo_region_cd and 
-- bucketed into 2 buckets ob mds_fam_id column
