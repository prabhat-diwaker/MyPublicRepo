...
if __name__ == '__main__':
    ...
    df_emp_base = spark.read.table("edureka_dw.employees_table")
    df_emp_scd = spark.read.table("edureka_dw.employees_scd").withColumnRenamed("employee_id","employee_id_scd")

    new_employees_in_source = df_emp_base.alias("base") \
                                .join(df_emp_scd.alias("scd"),(df_emp_scd.employee_id_scd==df_emp_base.employee_id),"left")\
    ...
    updated_employees_ids_in_source = df_emp_base.alias("base")\
                        .join(active_employee_records.alias("active"),df_emp_base.employee_id==active_employee_records.employee_id_scd,"inner")\
    ...
    updated_employees_in_source_stg2 = df_emp_base.alias("base")\
                                                .join(updated_employees_ids_in_source.alias("updated"),df_emp_base.employee_id==updated_employees_ids_in_source.employee_id,"inner")\
                                                .select("base.employee_id",
                                                        "first_name",
                                                        "last_name",
                                                        "email",
    ...
    unchanged_employees_in_scd = df_emp_scd.alias("scd")\
                                            ...
                                            .select(    "employee_id_scd",
                                                       ...
                                                       "department_id",
                                                        ...
                                                        "Active_Flag",
                                                        "row_insertion_dttm"
                                                    ).withColumnRenamed("employee_id_scd","employee_id")
    ...
    temp_df = spark.read.table("edureka_dw.scd_temp")
