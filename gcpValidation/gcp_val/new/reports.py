...
def sendMail():
    ...
    recipient_list = ['prabhat.diwaker@walmartlabs.com']
    ...
    xl_report =  abs_path + "reports/" + "summary_report_" + curr_date + ".xls"
    txt_report = abs_path + "reports/" +  "summary_report_" + curr_date + ".txt"
